...
namespace Generated.Improbable.Gdk.Tests
{
    public partial class NestedComponent
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<SpatialOSNestedComponent.Update>> Storage = new Dictionary<uint, List<SpatialOSNestedComponent.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<SpatialOSNestedComponent.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<SpatialOSNestedComponent.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<SpatialOSNestedComponent.Update> value)
                {
