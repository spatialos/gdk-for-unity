...
namespace Generated.Improbable.Gdk.Tests
{
    public partial class NestedComponent
    {
        internal class GameObjectComponentDispatcher : GameObjectComponentDispatcherBase
        {
            ...
            {
                ComponentType.ReadOnly<AuthorityChanges<SpatialOSNestedComponent>>(), ComponentType.ReadOnly<GameObjectReference>(),
            ...
            {
                ComponentType.ReadOnly<AuthorityChanges<SpatialOSNestedComponent>>(), ComponentType.ReadOnly<GameObjectReference>(),
                ComponentType.ReadOnly<NotAuthoritative<SpatialOSNestedComponent>>()
            };

            public override ComponentType[] AuthorityLossImminentComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<AuthorityChanges<SpatialOSNestedComponent>>(), ComponentType.ReadOnly<GameObjectReference>(),
                ComponentType.ReadOnly<AuthorityLossImminent<SpatialOSNestedComponent>>()
            };

            public override ComponentType[] ComponentsUpdatedComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<SpatialOSNestedComponent.ReceivedUpdates>(), ComponentType.ReadOnly<GameObjectReference>()
            };
            ...
            public override void MarkAuthorityGainedForActivation(Dictionary<int, MonoBehaviourActivationManager> entityIndexToManagers)
            {
                ...
                var authoritiesChangedTags = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<SpatialOSNestedComponent>>();
            ...
            public override void MarkAuthorityLostForDeactivation(Dictionary<int, MonoBehaviourActivationManager> entityIndexToManagers)
            {
                ...
                var authoritiesChangedTags = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<SpatialOSNestedComponent>>();
            ...
            public override void InvokeOnComponentUpdateCallbacks(Dictionary<int, InjectableStore> entityIndexToInjectableStore)
            {
                ...
                var updateLists = ComponentsUpdatedComponentGroup.GetComponentDataArray<SpatialOSNestedComponent.ReceivedUpdates>();
                for (var i = 0; i < entities.Length; i++)
                {
            ...
            public override void InvokeOnAuthorityGainedCallbacks(Dictionary<int, InjectableStore> entityIndexToInjectableStore)
            {
                ...
                var entities = AuthorityGainedComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<SpatialOSNestedComponent>>();
            ...
            public override void InvokeOnAuthorityLostCallbacks(Dictionary<int, InjectableStore> entityIndexToInjectableStore)
            {
                ...
                var entities = AuthorityLostComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<SpatialOSNestedComponent>>();
            ...
            private bool IsFirstAuthChange(Authority authToMatch, AuthorityChanges<SpatialOSNestedComponent> changeOps)
            {
