...
namespace Generated.Improbable.Gdk.Tests
{
    public partial class ExhaustiveRepeated
    {
        internal class GameObjectComponentDispatcher : GameObjectComponentDispatcherBase
        {
            ...
            {
                ComponentType.ReadOnly<AuthorityChanges<SpatialOSExhaustiveRepeated>>(), ComponentType.ReadOnly<GameObjectReference>(),
                ComponentType.ReadOnly<NotAuthoritative<SpatialOSExhaustiveRepeated>>()
            };

            public override ComponentType[] AuthorityLossImminentComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<AuthorityChanges<SpatialOSExhaustiveRepeated>>(), ComponentType.ReadOnly<GameObjectReference>(),
                ComponentType.ReadOnly<AuthorityLossImminent<SpatialOSExhaustiveRepeated>>()
            };
            ...
            public override void MarkAuthorityGainedForActivation(Dictionary<int, MonoBehaviourActivationManager> entityIndexToManagers)
            {
                ...
                var authoritiesChangedTags = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<SpatialOSExhaustiveRepeated>>();
            ...
            public override void MarkAuthorityLostForDeactivation(Dictionary<int, MonoBehaviourActivationManager> entityIndexToManagers)
            {
                ...
                var authoritiesChangedTags = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<SpatialOSExhaustiveRepeated>>();
            ...
            public override void InvokeOnAuthorityGainedCallbacks(Dictionary<int, InjectableStore> entityIndexToInjectableStore)
            {
                ...
                var entities = AuthorityGainedComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<SpatialOSExhaustiveRepeated>>();
            ...
            public override void InvokeOnAuthorityLostCallbacks(Dictionary<int, InjectableStore> entityIndexToInjectableStore)
            {
                ...
                var entities = AuthorityLostComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<SpatialOSExhaustiveRepeated>>();
            ...
            private bool IsFirstAuthChange(Authority authToMatch, AuthorityChanges<SpatialOSExhaustiveRepeated> changeOps)
            {
