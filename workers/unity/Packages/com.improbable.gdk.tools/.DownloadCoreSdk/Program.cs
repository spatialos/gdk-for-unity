    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var packages = new List<Package>
            {
                ...
                new Package(tempPath, "worker_sdk", "csharp-c-bindings", $"{managedDependenciesPath}/Common"),
                new Package(tempPath, "worker_sdk", "csharp-c-bindings-static", $"{managedDependenciesPath}/iOS"),
