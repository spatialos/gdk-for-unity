...
namespace Improbable.Gdk.QueryBasedInterest
{
    ...
    public class InterestTemplate
    {
        ...
        ///     An InterestTemplate object.
        /// </returns>
        public InterestTemplate AddQueries<T>(ComponentInterest.Query query,
        ...
        ///     Component ID of the authoritative component to add the queries to.
        /// </param>
        /// <param name="query">
        ///     First query to add for a given authoritative component.
        /// </param>
            ...
            params ComponentInterest.Query[] queries)
        {
            ...
            componentInterest.Queries.AddRange(interestQueries);
            return this;
        }
        ...
        ///     An InterestTemplate object.
        /// </returns>
        public InterestTemplate ReplaceQueries<T>(ComponentInterest.Query query,
            params ComponentInterest.Query[] queries)
            where T : ISpatialComponentData
        {
        ...
        /// </summary>
        /// <param name="componentId">
        ///     Component ID of the authoritative component to replace queries of.
        /// </param>
        /// <param name="query">
        ///     First query to add for a given authoritative component.
        /// </param>
        ...
        /// </summary>
        /// <param name="componentId">
        ///     Component ID of the authoritative component to clear queries from.
        /// </param>
        /// <returns>
        ///     An InterestTemplate object.
        /// </returns>
