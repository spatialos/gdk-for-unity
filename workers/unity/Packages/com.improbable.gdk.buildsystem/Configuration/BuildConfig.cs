            ...
            WorkerBuildConfigurations = new List<WorkerBuildConfiguration>
            {
                new WorkerBuildConfiguration
                {
                    ...
                    CloudBuildConfig = new BuildEnvironmentConfig(
                        ...
                        new BuildTargetConfig(BuildTarget.StandaloneOSX, BuildOptions.Development, true, false),
                        new BuildTargetConfig(BuildTarget.StandaloneWindows64, BuildOptions.Development, true, false))
                },
                new WorkerBuildConfiguration
                {
