...
namespace Improbable.Gdk.Core
{
    ...
    public class CleanReactiveComponentsSystem : ComponentSystem
    {
        ...
        public void UsedOnlyForAotCodeGeneration()
        {
            ...
            // Mono also needs this line.
            new CleanReactiveComponentsSystem().GenerateComponentGroups();

            // We include an exception so we can be sure to know if this method is ever called.
