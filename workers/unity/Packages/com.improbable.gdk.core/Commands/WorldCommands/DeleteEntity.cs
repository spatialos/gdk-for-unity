...
namespace Improbable.Gdk.Core.Commands
{
    public static partial class WorldCommands
    {
        public static class DeleteEntity
        {
            ...
            public class DeleteEntityCommandManager : IWorldCommandManager<Request, ReceivedResponse>
            {
                ...
                {
                    foreach (var response in diff.GetWorldCommandStorage().GetDeleteEntityResponses())
                    {
