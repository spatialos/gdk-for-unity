...
namespace Improbable.Gdk.Core.GameObjectRepresentation
{
    ...
    public class RequiredFieldInjector
    {
        ...
        private const string BadRequiredMemberWarning
            ...
            + "Please make sure that types marked with [Require] are part of the ECS API of the SpatialOS GDK and that they are located in the <component name>.Requirable or WorldsCommands.Requirable namespace.";
