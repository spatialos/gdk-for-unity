    ...
    public static partial class WorldCommands
    {
        public static partial class Requirable
        {
            ...
            public class WorldCommandRequestSender : RequirableBase
            {
                ...
                /// </param>
                /// <returns>The request ID of the command request.</returns>
                public long EntityQuery(Improbable.WorkerCore.Query.EntityQuery entityQuery, uint? timeoutMillis = null,
                    object context = null)
                {
                    if (!IsValid())
                    {
                ...
                /// </param>
                /// <returns>The request ID of the command request.</returns>
                public long EntityQuery(Improbable.WorkerCore.Query.EntityQuery entityQuery,
