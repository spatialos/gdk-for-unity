...
Reactive components will be removed in a future release, **we strongly recommend to migrate off reactive components**. You can find the APIs to replace reactive components in the [ECS section of the workflows documentation](https://docs.improbable.io/unity/alpha/reference/workflows/overview).
