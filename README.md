# The SpatialOS GDK for Unity readme (pre-alpha)
...
This release is for evaluation and feedback only, with limited documentation; we aren’t supporting any game development on the pre-alpha version of the GDK.
