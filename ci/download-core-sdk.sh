...
spatial package retrieve "worker_sdk" "core-dynamic-arm-ios"         "${PINNED_CORE_SDK_VERSION}" "${CORE_SDK_DIR}/worker_sdk/core-dynamic-arm-ios"
...
cleanAndUnpackTo "${CORE_SDK_DIR}/worker_sdk/core-dynamic-arm-ios"           "${NATIVE_DEPENDENCIES_PATH}/iOS"
