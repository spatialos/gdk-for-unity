...
- Added first version of the Network Analyzer, a new inspector to view live bandwidth usage per component. `SpatialOS->Window->Network Analyzer` [#1148](https://github.com/spatialos/gdk-for-unity/pull/1148)
