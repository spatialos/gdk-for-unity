...
- Upgrade the com.unity.entities packages to 0.3.0-preview.4. [#1337](https://github.com/spatialos/gdk-for-unity/pull/1337)
    ...
    - build-in Unity AssetBundle module is now required.
