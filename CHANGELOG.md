...
- Fixed an incorrect callback registration when entities creation/removal request is sent by the `WorldCommandSender`. [#1473](https://github.com/spatialos/gdk-for-unity/pull/1462)
