...
- The `RedirectedProcess.WithArgs` API will now concatinate arguments, instead of replace the previously provided arguments. [#1260](https://github.com/spatialos/gdk-for-unity/pull/1260)
...
- Added `RedirectedProcess.Spatial` wrapper for calling the spatial toolbelt. This wrapper automatically uses the current project environment. [#1260](https://github.com/spatialos/gdk-for-unity/pull/1260)
...
- Upgrade to Platform SDK v14.4.0. [#1260](https://github.com/spatialos/gdk-for-unity/pull/1260)
  - This only affects the DeploymentLauncher.
