...
| [Writer [Require] fields](content/gameobject/reading-and-writing-component-data.md#how-to-update-component-properties): Updating a component using `Writer.Send` will lead to all properties of the component being updated. | 2018/09/25 | None | None | No |
...
| [Reader [Require] fields](content/gameobject/reading-and-writing-component-data.md#how-to-react-to-component-property-changes): Component update callbacks for specific properties (`Reader.<component property name>Updated`) are invoked if any property of a component was changed. | 2018/09/25 | None | Verify manually whether a component property was actually changed. | No |git s