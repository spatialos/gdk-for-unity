...
| Cannot safely access component data from entity queries. To protect the integrity of the worker, these requests will be dropped before sending.                                                                   | 2018/09/19 | None         | Don't send entity queries where `ResultType` is `SnapshotResultType` | No     |
