...
* The introduction to the two workflows: [the MonoBehaviour and ECS Workflows](\{\{urlRoot\}\}/reference/intro-workflows-spatialos-entities.md). <br/>
...
* The background document on [workers in the GDK](\{\{urlRoot\}\}/reference/workers/workers-in-the-gdk.md).

* The guide on [how to create SpatialOS entity templates](\{\{urlRoot\}\}/reference/entity-templates.md).

### Workflows

#### MonoBehaviour

If you are using the MonoBehaviour workflow, you should look at [How to link SpatialOS entities with GameObjects](\{\{urlRoot\}\}/reference/gameobject/linking-spatialos-entities.md), once you have looked at the above three documents.
