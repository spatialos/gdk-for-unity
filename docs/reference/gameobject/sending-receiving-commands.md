...
These can be injected into your MonoBehaviour scripts in the same way as [Readers and Writers](\{\{urlRoot\}\}/reference/gameobject/readers-writers) by defining a field of one of the above-mentioned types and decorating it with the `[Require]` attribute.
...
> For an example of how to create an entity, you can look at the [how to create and delete entities](\{\{urlRoot\}\}/reference/gameobject/create-delete-spatialos-entities) document.
