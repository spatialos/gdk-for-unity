...
The following examples assume that you have a [GameObject that is linked to a SpatialOS entity](\{\{urlRoot\}\}/reference/gameobject/linking-spatialos-entities) containing the `Health` component.
