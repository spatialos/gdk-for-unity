...
Before reading this document, make sure you are familiar with
  ...
  * [Workers](\{\{urlRoot\}\}/reference/workers/workers-in-the-gdk)
  * [Readers and Writers](\{\{urlRoot\}\}/reference/gameobject/readers-writers)

You can [represent your SpatialOS entities as GameObjects](\{\{urlRoot\}\}/reference/gameobject/linking-spatialos-entities).
 ...
 * [Readers and Writers](\{\{urlRoot\}\}/reference/gameobject/readers-writers) - For accessing the component data of the SpatialOS entity.
 * [Sending and Receiving component commands](\{\{urlRoot\}\}/reference/gameobject/sending-receiving-commands) - For sending and receiving commands.
...
The requirements depend on which types are marked as required in the Monobehaviour. Please read their API documentation to learn more:
  ...
  * [Readers and Writers API](\{\{urlRoot\}\}/reference/gameobject/readers-writers)
  * [Command sender and handler API](\{\{urlRoot\}\}/reference/gameobject/sending-receiving-commands)
