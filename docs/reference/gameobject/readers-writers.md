...
You can use Readers and Writers by declaring a field in your MonoBehaviour and decorating it with the `[Require]` attribute (See documentation on [interacting with SpatialOS using MonoBehaviours)](\{\{urlRoot\}\}/reference/gameobject/interact-spatialos-monobehaviours). The GDK automatically injects these fields with their corresponding Readers and Writers, if the following requirements are fulfilled:
...
You can find out more about how to work with Readers and Writers in:
  ...
  * [How to read, update and react to changes](\{\{urlRoot\}\}/reference/gameobject/reading-and-writing-component-data)
  * [How to send and receive events](\{\{urlRoot\}\}/reference/gameobject/sending-receiving-events)
