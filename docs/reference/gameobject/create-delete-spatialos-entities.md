...
Before reading this document, make sure you are familiar with:
  ...
  * [(MonoBehaviour) How to interact with SpatialOS using MonoBehaviours](\{\{urlRoot\}\}/reference/gameobject/interact-spatialos-monobehaviours)
...
To see the exact API for using world commands inside a MonoBehaviour, take a look at the [World command request sender and receiver API](\{\{urlRoot\}\}/reference/gameobject/world-commands)
### How to create a SpatialOS entity
To create an entity, you

  * [define the entity's template](\{\{urlRoot\}\}/reference/entity-templates)
  * [send the `CreateEntity` world command](\{\{urlRoot\}\}/reference/gameobject/world-commands#createentity).

> When you create an entity, the SpatialOS GDK for Unity by default does not associate a GameObject with it. For more information on how to enable this, see [representing entities with gameobjects](\{\{urlRoot\}\}/reference/gameobject/linking-spatialos-entities).
...
To delete an entity, you
  ...
  * [send the `DeleteEntity` world command](\{\{urlRoot\}\}/reference/gameobject/world-commands#deleteentity).

> Do not delete the linked GameObjects. The GDK handles deleting the linked GameObjects, if you used the [GameObject creation feature module](\{\{urlRoot\}\}/reference/gameobject/linking-spatialos-entities) to link your SpatialOS entities to GameObjects. Deleting GameObjects locally will break many things badly.
