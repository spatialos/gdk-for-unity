...
* SpatialOS GDK for Unity documentation - [Testing overview](\{\{urlRoot\}\}/reference/testing/testing-overview)
* SpatialOS GDK for Unity documentation - [How to run tests](\{\{urlRoot\}\}/reference/testing/how-to-run-tests)
* SpatialOS GDK for Unity documentation - [Testing guidelines](\{\{urlRoot\}\}/reference/testing/testing-guidelines)
...
Following the [test directory structure instructions](\{\{urlRoot\}\}/reference/testing/testing-guidelines#test-directory-structure-and-file-names), the test filename would be:
