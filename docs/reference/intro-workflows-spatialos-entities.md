...
> ECS is an alternative Unity development paradigm, introduced by Unity in early 2018. Find out more on [Unity’s GitHub](https://github.com/Unity-Technologies/EntityComponentSystemSamples/blob/master/Documentation/reference/ecs_in_detail.md#world).
...
>You can read more about SpatialOS workers in the [SpatialOS concept documentation](https://docs.improbable.io/reference/latest/shared/concepts/workers-load-balancing), the [GDK glossary](\{\{urlRoot\}\}/reference/glossary#worker) and the GDK documentation on [workers](\{\{urlRoot\}\}/reference/workers/workers-in-the-gdk).  
...
* Both workflows - [SpatialOS entities: Creating entity templates](\{\{urlRoot\}\}/reference/entity-templates)

* Both workflows - [SpatialOS entities: How to create and delete SpatialOS entities](\{\{urlRoot\}\}/reference/gameobject/create-delete-spatialos-entities)

* MonoBehaviour workflow - [SpatialOS entities: How to link SpatialOS entities with GameObjects](\{\{urlRoot\}\}/reference/gameobject/linking-spatialos-entities)
