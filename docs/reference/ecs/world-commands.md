...
You can use the `CreateEntity` world command to request the creation of a new SpatialOS entity which you specified using an [entity template](\{\{urlRoot\}\}/reference/entity-templates).
...
Below is an example of creating a SpatialOS entity. For more information on how to create a `CreatureTemplate`, see the [creating entity templates](\{\{urlRoot\}\}/reference/entity-templates) page.
