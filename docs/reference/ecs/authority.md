<%(TOC)%>
# ECS: Authority
 _This document relates to the [ECS workflow](\{\{urlRoot\}\}/reference/intro-workflows-spatialos-entities.md)._
...
The GDK automatically adds and removes authority tags: see [Reactive components](\{\{urlRoot\}\}/reference/ecs/reactive-components) for more information.
