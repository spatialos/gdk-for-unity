# omponents and component updates
...
> Note that code generation runs when you open your Unity Editor or when you select **Improbable** > **Generate Code** from the Editor menu.
