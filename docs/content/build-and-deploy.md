...
1. Ensure you set the `name` field in the `spatialos.json` to a SpatialOS project that you have access to. You can find your project name in the [SpatialOS Console](https://console.improbable.io/). It’ll be something like `beta_someword_anotherword_000`.
