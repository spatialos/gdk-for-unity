...
## Get the dependencies for developing Android games
  ...
  1. Install Android prerequisites:
    * [Android Studio](https://developer.android.com/studio/)
       ...
       * Once the instalation is complete, open Android Studio and select **File** > **Settings**.<br>
         In the Settings window, navigate to **Appearance & Behavior** > **System Settings** > **Android SDK** > **SDK Platforms** and select the platform you intend to develop your game for. Select **Apply** to download and install that Android SDK version.
