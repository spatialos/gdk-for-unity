...
<%(Callout message="If you are using one of our Starter Projects, you can skip the **Create a mobile connector script** section below, as you already have one in your project. Move onto the [Unity Editor](#in-editor) section.")%>
