...
For more information, see the following documentation:
  ...
  * [Run your game with Unity Remote]({{urlRoot}}/content/mobile/ios/local-deploy#connect-your-ios-mobile-device-using-unity-remote)
...
For more information, see the following documentation:
  ...
  * [Deploy your game with the iOS Simulator]({{urlRoot}}/content/mobile/ios/local-deploy#connect-your-ios-simulator)
...
For more information, see the following documentation:
  ...
  * [Deploy your game to an iOS device]({{urlRoot}}/content/mobile/ios/local-deploy#connect-your-ios-mobile-device)
