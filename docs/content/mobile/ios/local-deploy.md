...
1. When you're done, select the **Play** button in XCode to stop your client and, in the terminal window that's running the SpatialOS process, enter **Ctrl+C** to stop the process.
...
1. Still in XCode, click the Play button in the top left of the window. This will install the game as an app on your device and start it.
