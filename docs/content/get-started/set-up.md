...
> **NOTE:** If you have downloaded the source code via a zip file, skip the rest of this page and move on to the next section of this page: [Open the FPS Starter Project in your Unity Editor](#open-the-fps-starter-project-in-your-unity-editor).
...
> **NOTE:** You can only clone via SSH if you have already [set up SSH keys (GitHub help)](https://help.github.com/articles/connecting-to-github-with-ssh/) with your GitHub account.

#### 2. Clone the GDK for Unity repository
