...
1. Install prerequisites:
	...
	- [Unity 2018.2.0f2](https://unity3d.com/get-unity/download/archive) with Linux Build Support, Mac Build Support (IL2CPP) and Windows Build Support (Mono) components selected during the installation process.
