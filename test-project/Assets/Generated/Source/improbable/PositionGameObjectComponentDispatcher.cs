...
namespace Generated.Improbable
{
    public partial class Position
    {
        internal class GameObjectComponentDispatcher : GameObjectComponentDispatcherBase
        {
            ...
            {
                ComponentType.ReadOnly<ComponentAdded<Generated.Improbable.Position.Component>>(), ComponentType.ReadOnly<GameObjectReference>()
            };

            public override ComponentType[] ComponentRemovedComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<ComponentRemoved<Generated.Improbable.Position.Component>>(), ComponentType.ReadOnly<GameObjectReference>()
            };

            public override ComponentType[] AuthorityGainedComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<AuthorityChanges<Generated.Improbable.Position.Component>>(), ComponentType.ReadOnly<GameObjectReference>(),
            ...
            {
                ComponentType.ReadOnly<AuthorityChanges<Generated.Improbable.Position.Component>>(), ComponentType.ReadOnly<GameObjectReference>(),
                ComponentType.ReadOnly<NotAuthoritative<Generated.Improbable.Position.Component>>()
            };

            public override ComponentType[] AuthorityLossImminentComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<AuthorityChanges<Generated.Improbable.Position.Component>>(), ComponentType.ReadOnly<GameObjectReference>(),
                ComponentType.ReadOnly<AuthorityLossImminent<Generated.Improbable.Position.Component>>()
            };

            public override ComponentType[] ComponentsUpdatedComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<Generated.Improbable.Position.ReceivedUpdates>(), ComponentType.ReadOnly<GameObjectReference>()
            };
            ...
            private const uint componentId = 54;
            ...
            public override void MarkAuthorityGainedForActivation(Dictionary<Unity.Entities.Entity, MonoBehaviourActivationManager> entityToManagers)
            {
                ...
                var authoritiesChangedTags = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<Generated.Improbable.Position.Component>>();
            ...
            public override void MarkAuthorityLostForDeactivation(Dictionary<Unity.Entities.Entity, MonoBehaviourActivationManager> entityToManagers)
            {
                ...
                var authoritiesChangedTags = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<Generated.Improbable.Position.Component>>();
            ...
            public override void InvokeOnComponentUpdateCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                var updateLists = ComponentsUpdatedComponentGroup.GetComponentDataArray<Generated.Improbable.Position.ReceivedUpdates>();
                for (var i = 0; i < entities.Length; i++)
                {
            ...
            public override void InvokeOnAuthorityGainedCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                var entities = AuthorityGainedComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<Generated.Improbable.Position.Component>>();
            ...
            public override void InvokeOnAuthorityLostCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                var entities = AuthorityLostComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<Generated.Improbable.Position.Component>>();
            ...
            private bool IsFirstAuthChange(Authority authToMatch, AuthorityChanges<Generated.Improbable.Position.Component> changeOps)
            {
