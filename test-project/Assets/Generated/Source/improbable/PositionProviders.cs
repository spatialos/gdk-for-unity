...
namespace Generated.Improbable
{
    public partial class Position
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<Generated.Improbable.Position.Update>> Storage = new Dictionary<uint, List<Generated.Improbable.Position.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<Generated.Improbable.Position.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<Generated.Improbable.Position.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<Generated.Improbable.Position.Update> value)
                {
