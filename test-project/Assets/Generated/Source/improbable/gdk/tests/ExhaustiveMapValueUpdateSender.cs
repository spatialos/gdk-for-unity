    ...
    public partial class ExhaustiveMapValue
    {
        internal class ComponentReplicator : IComponentReplicationHandler
        {
            ...
            public EntityQueryDesc ComponentUpdateQuery => new EntityQueryDesc
            {
                All = new[]
                {
                    ComponentType.ReadWrite<global::Improbable.Gdk.Tests.ExhaustiveMapValue.Component>(),
                    ComponentType.ReadWrite<global::Improbable.Gdk.Tests.ExhaustiveMapValue.ComponentAuthority>(),
