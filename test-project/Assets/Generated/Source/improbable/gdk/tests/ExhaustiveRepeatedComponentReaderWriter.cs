...
namespace Improbable.Gdk.Tests
{
    ...
    public class ExhaustiveRepeatedReaderSubscriptionManager : SubscriptionManager<ExhaustiveRepeatedReader>
    {
        private readonly EntityManager entityManager;
        private readonly World world;
        private readonly WorkerSystem workerSystem;

        private Dictionary<EntityId, HashSet<Subscription<ExhaustiveRepeatedReader>>> entityIdToReaderSubscriptions;
        ...
        public ExhaustiveRepeatedReaderSubscriptionManager(World world)
        {
            this.world = world;
            ...
            constraintCallbackSystem.RegisterComponentAddedCallback(ExhaustiveRepeated.ComponentId, entityId =>
            {
                ...
                {
                    subscription.SetAvailable(new ExhaustiveRepeatedReader(world, entity, entityId));
                }
            ...
            constraintCallbackSystem.RegisterComponentRemovedCallback(ExhaustiveRepeated.ComponentId, entityId =>
            {
        ...
        public override Subscription<ExhaustiveRepeatedReader> Subscribe(EntityId entityId)
        {
            if (entityIdToReaderSubscriptions == null)
            {
                entityIdToReaderSubscriptions = new Dictionary<EntityId, HashSet<Subscription<ExhaustiveRepeatedReader>>>();
            }

            var subscription = new Subscription<ExhaustiveRepeatedReader>(this, entityId);

            if (!entityIdToReaderSubscriptions.TryGetValue(entityId, out var subscriptions))
            {
                subscriptions = new HashSet<Subscription<ExhaustiveRepeatedReader>>();
                entityIdToReaderSubscriptions.Add(entityId, subscriptions);
            }

            if (workerSystem.TryGetEntity(entityId, out var entity)
                && entityManager.HasComponent<ExhaustiveRepeated.Component>(entity))
            {
                entitiesMatchingRequirements.Add(entityId);
                subscription.SetAvailable(new ExhaustiveRepeatedReader(world, entity, entityId));
            }
    ...
    [AutoRegisterSubscriptionManager]
    public class ExhaustiveRepeatedWriterSubscriptionManager : SubscriptionManager<ExhaustiveRepeatedWriter>
    {
        private readonly World world;
        private readonly WorkerSystem workerSystem;
        private readonly ComponentUpdateSystem componentUpdateSystem;

        private Dictionary<EntityId, HashSet<Subscription<ExhaustiveRepeatedWriter>>> entityIdToWriterSubscriptions;

        private HashSet<EntityId> entitiesMatchingRequirements = new HashSet<EntityId>();
        private HashSet<EntityId> entitiesNotMatchingRequirements = new HashSet<EntityId>();

        public ExhaustiveRepeatedWriterSubscriptionManager(World world)
        {
            this.world = world;
            ...
            constraintCallbackSystem.RegisterAuthorityCallback(ExhaustiveRepeated.ComponentId, authorityChange =>
            {
                if (authorityChange.Authority == Authority.Authoritative)
                {
                    ...
                    {
                        subscription.SetAvailable(new ExhaustiveRepeatedWriter(world, entity, authorityChange.EntityId));
                    }
        ...
        public override Subscription<ExhaustiveRepeatedWriter> Subscribe(EntityId entityId)
        {
            if (entityIdToWriterSubscriptions == null)
            {
                entityIdToWriterSubscriptions = new Dictionary<EntityId, HashSet<Subscription<ExhaustiveRepeatedWriter>>>();
            }

            var subscription = new Subscription<ExhaustiveRepeatedWriter>(this, entityId);

            if (!entityIdToWriterSubscriptions.TryGetValue(entityId, out var subscriptions))
            {
                subscriptions = new HashSet<Subscription<ExhaustiveRepeatedWriter>>();
                entityIdToWriterSubscriptions.Add(entityId, subscriptions);
            }

            if (workerSystem.TryGetEntity(entityId, out var entity)
                && componentUpdateSystem.HasComponent(ExhaustiveRepeated.ComponentId, entityId)
                && componentUpdateSystem.GetAuthority(entityId, ExhaustiveRepeated.ComponentId) != Authority.NotAuthoritative)
            {
                entitiesMatchingRequirements.Add(entityId);
                subscription.SetAvailable(new ExhaustiveRepeatedWriter(world, entity, entityId));
            }
            else
            {
                entitiesNotMatchingRequirements.Add(entityId);
    ...
    public class ExhaustiveRepeatedReader
    {
        public bool IsValid;
        ...
        public ExhaustiveRepeated.Component Data
        {
            get
            {
                if (!IsValid)
        ...
        public event Action<Authority> OnAuthorityUpdate
        {
            add
            {
                ...
                var key = CallbackSystem.RegisterAuthorityCallback(EntityId, ExhaustiveRepeated.ComponentId, value);
        ...
        private Dictionary<Action<ExhaustiveRepeated.Update>, ulong> updateCallbackToCallbackKey;
        public event Action<ExhaustiveRepeated.Update> OnUpdate
        {
            add
            {
                if (updateCallbackToCallbackKey == null)
                {
                    updateCallbackToCallbackKey = new Dictionary<Action<ExhaustiveRepeated.Update>, ulong>();
                }
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<BlittableBool>>, ulong> field1UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<BlittableBool>> OnField1Update
        {
            add
            {
                if (field1UpdateCallbackToCallbackKey == null)
                {
                    field1UpdateCallbackToCallbackKey = new Dictionary<Action<global::System.Collections.Generic.List<BlittableBool>>, ulong>();
                }

                var key = CallbackSystem.RegisterComponentUpdateCallback<ExhaustiveRepeated.Update>(EntityId, update =>
                {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<float>>, ulong> field2UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<float>> OnField2Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<byte[]>>, ulong> field3UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<byte[]>> OnField3Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<int>>, ulong> field4UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<int>> OnField4Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<long>>, ulong> field5UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<long>> OnField5Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<double>>, ulong> field6UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<double>> OnField6Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<string>>, ulong> field7UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<string>> OnField7Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<uint>>, ulong> field8UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<uint>> OnField8Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<ulong>>, ulong> field9UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<ulong>> OnField9Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<int>>, ulong> field10UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<int>> OnField10Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<long>>, ulong> field11UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<long>> OnField11Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<uint>>, ulong> field12UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<uint>> OnField12Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<ulong>>, ulong> field13UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<ulong>> OnField13Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<int>>, ulong> field14UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<int>> OnField14Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<long>>, ulong> field15UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<long>> OnField15Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<global::Improbable.Gdk.Core.EntityId>>, ulong> field16UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<global::Improbable.Gdk.Core.EntityId>> OnField16Update
        {
            add
            {
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<global::Improbable.Gdk.Tests.SomeType>>, ulong> field17UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<global::Improbable.Gdk.Tests.SomeType>> OnField17Update
        {
            add
            {
                if (field17UpdateCallbackToCallbackKey == null)
                {
                    field17UpdateCallbackToCallbackKey = new Dictionary<Action<global::System.Collections.Generic.List<global::Improbable.Gdk.Tests.SomeType>>, ulong>();
                }
        ...
        private Dictionary<Action<global::System.Collections.Generic.List<global::Improbable.Gdk.Tests.SomeEnum>>, ulong> field18UpdateCallbackToCallbackKey;
        public event Action<global::System.Collections.Generic.List<global::Improbable.Gdk.Tests.SomeEnum>> OnField18Update
        {
            add
            {
                if (field18UpdateCallbackToCallbackKey == null)
                {
                    field18UpdateCallbackToCallbackKey = new Dictionary<Action<global::System.Collections.Generic.List<global::Improbable.Gdk.Tests.SomeEnum>>, ulong>();
                }
        ...
        internal ExhaustiveRepeatedReader(World world, Entity entity, EntityId entityId)
        {
            Entity = entity;
            EntityId = entityId;
    ...
    public class ExhaustiveRepeatedWriter : ExhaustiveRepeatedReader
    {
        ...
        public void SendUpdate(ExhaustiveRepeated.Update update)
        {
            var component = EntityManager.GetComponentData<ExhaustiveRepeated.Component>(Entity);
        ...
        {
            ComponentUpdateSystem.AcknowledgeAuthorityLoss(EntityId, ExhaustiveRepeated.ComponentId);
        }
    }
}
