...
namespace Generated.Improbable.Gdk.Tests
{
    public partial class NestedComponent
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<Generated.Improbable.Gdk.Tests.NestedComponent.Update>> Storage = new Dictionary<uint, List<Generated.Improbable.Gdk.Tests.NestedComponent.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<Generated.Improbable.Gdk.Tests.NestedComponent.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<Generated.Improbable.Gdk.Tests.NestedComponent.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<Generated.Improbable.Gdk.Tests.NestedComponent.Update> value)
                {
