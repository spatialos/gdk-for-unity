        ...
        internal class ComponentCleanup : ComponentCleanupHandler
        {
            public override EntityArchetypeQuery CleanupArchetypeQuery => new EntityArchetypeQuery
            {
                ...
                Any = new ComponentType[]
                {
                    ...
                    ComponentType.ReadOnly<Improbable.Gdk.Tests.ComponentsWithNoFields.ComponentWithNoFields.ReceivedUpdates>(),
                    ComponentType.ReadOnly<AuthorityChanges<Improbable.Gdk.Tests.ComponentsWithNoFields.ComponentWithNoFields.Component>>(),
                },
                ...
                EntityCommandBuffer buffer)
            {
                ...
                foreach (var chunk in chunkArray)
                {
                    ...
                    // Updates
                    var updateArray = new NativeArray<Improbable.Gdk.Tests.ComponentsWithNoFields.ComponentWithNoFields.ReceivedUpdates>();
                    ...
                    // Authority
                    var authorityChangeArray = new NativeArray<AuthorityChanges<Improbable.Gdk.Tests.ComponentsWithNoFields.ComponentWithNoFields.Component>>();
