...
namespace Improbable.Gdk.Tests
{
    public partial class ExhaustiveBlittableSingular
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<Improbable.Gdk.Tests.ExhaustiveBlittableSingular.Update>> Storage = new Dictionary<uint, List<Improbable.Gdk.Tests.ExhaustiveBlittableSingular.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<Improbable.Gdk.Tests.ExhaustiveBlittableSingular.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<Improbable.Gdk.Tests.ExhaustiveBlittableSingular.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<Improbable.Gdk.Tests.ExhaustiveBlittableSingular.Update> value)
                {
