    ...
    public partial class Connection
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            private void ApplyUpdate(in ComponentUpdateReceived<Update> update)
            {
                ...
                if (!entityManager.HasComponent<Improbable.Gdk.Tests.AlternateSchemaSyntax.Connection.Component>(entity))
                {
                    return;
                }
                ...
                if (update.Update.Value.HasValue)
                {
                    data.Value = update.Update.Value.Value;
                }
