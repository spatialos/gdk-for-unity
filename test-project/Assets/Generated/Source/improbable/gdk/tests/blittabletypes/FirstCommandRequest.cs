...
{ 
    ...
    public struct FirstCommandRequest
    {
        ...
        {
            public static void Serialize(FirstCommandRequest instance, global::Improbable.WorkerCore.SchemaObject obj)
            {
                {
            ...
            public static FirstCommandRequest Deserialize(global::Improbable.WorkerCore.SchemaObject obj)
            {
