...
[assembly: RegisterGenericComponentType(typeof(ComponentAdded<global::Improbable.Gdk.Tests.BlittableTypes.BlittableComponent.Component>))]
[assembly: RegisterGenericComponentType(typeof(ComponentRemoved<global::Improbable.Gdk.Tests.BlittableTypes.BlittableComponent.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityChanges<global::Improbable.Gdk.Tests.BlittableTypes.BlittableComponent.Component>))]
[assembly: RegisterGenericComponentType(typeof(Authoritative<global::Improbable.Gdk.Tests.BlittableTypes.BlittableComponent.Component>))]
[assembly: RegisterGenericComponentType(typeof(NotAuthoritative<global::Improbable.Gdk.Tests.BlittableTypes.BlittableComponent.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityLossImminent<global::Improbable.Gdk.Tests.BlittableTypes.BlittableComponent.Component>))]
        ...
        public class FirstEventEventReactiveComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                for (int i = 0; i < eventsReceived.Count; ++i)
                {
                    ...
                    List<global::Improbable.Gdk.Tests.BlittableTypes.FirstEventPayload> events;
                    ...
                    {
                        events = new List<global::Improbable.Gdk.Tests.BlittableTypes.FirstEventPayload>();
        ...
        public class SecondEventEventReactiveComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                for (int i = 0; i < eventsReceived.Count; ++i)
                {
                    ...
                    List<global::Improbable.Gdk.Tests.BlittableTypes.SecondEventPayload> events;
                    ...
                    {
                        events = new List<global::Improbable.Gdk.Tests.BlittableTypes.SecondEventPayload>();
            ...
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                foreach (var entityId in world.GetExistingSystem<EntitySystem>().GetEntitiesAdded())
                {
                    ...
                    entityManager.AddComponent(entity,
                        ComponentType.ReadWrite<NotAuthoritative<global::Improbable.Gdk.Tests.BlittableTypes.BlittableComponent.Component>>());
                }
            ...
            private void ApplyAuthorityChange(Unity.Entities.Entity entity, Authority authority, global::Improbable.Gdk.Core.EntityId entityId, World world, EntityManager entityManager)
            {
                switch (authority)
                {
                    case Authority.Authoritative:
                        ...
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<Authoritative<global::Improbable.Gdk.Tests.BlittableTypes.BlittableComponent.Component>>());
                    ...
                    case Authority.AuthorityLossImminent:
                        ...
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<AuthorityLossImminent<global::Improbable.Gdk.Tests.BlittableTypes.BlittableComponent.Component>>());
                        break;
                    case Authority.NotAuthoritative:
                        ...
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<NotAuthoritative<global::Improbable.Gdk.Tests.BlittableTypes.BlittableComponent.Component>>());
                        break;
                }
            }
