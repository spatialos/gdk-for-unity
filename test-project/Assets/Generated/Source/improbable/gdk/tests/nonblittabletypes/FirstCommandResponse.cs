...
{ 
    ...
    public struct FirstCommandResponse
    {
        ...
        {
            public static void Serialize(FirstCommandResponse instance, global::Improbable.WorkerCore.SchemaObject obj)
            {
                {
            ...
            public static FirstCommandResponse Deserialize(global::Improbable.WorkerCore.SchemaObject obj)
            {
