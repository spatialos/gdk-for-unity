    ...
    public partial class NonBlittableComponent
    {
        internal class DispatcherHandler : ComponentDispatcherHandler
        {
            ...
            private void OnFirstCommandRequest(CommandRequestOp op)
            {
                ...
                requests.Add(new Improbable.Gdk.Tests.NonblittableTypes.NonBlittableComponent.FirstCommand.ReceivedRequest(op.RequestId,
                    op.CallerWorkerId,
            ...
            private void OnFirstCommandResponse(CommandResponseOp op)
            {
                ...
                responses.Add(new Improbable.Gdk.Tests.NonblittableTypes.NonBlittableComponent.FirstCommand.ReceivedResponse(new EntityId(op.EntityId),
                    op.Message,
                    op.StatusCode,
                    response,
            ...
            private void OnSecondCommandRequest(CommandRequestOp op)
            {
                ...
                requests.Add(new Improbable.Gdk.Tests.NonblittableTypes.NonBlittableComponent.SecondCommand.ReceivedRequest(op.RequestId,
                    op.CallerWorkerId,
                    op.CallerAttributeSet,
                    deserializedRequest));
            }
            ...
            private void OnSecondCommandResponse(CommandResponseOp op)
            {
                ...
                responses.Add(new Improbable.Gdk.Tests.NonblittableTypes.NonBlittableComponent.SecondCommand.ReceivedResponse(new EntityId(op.EntityId),
                    op.Message,
                    op.StatusCode,
                    response,
                    requestBundle.Request,
            ...
            public override void ExecuteReplication(ComponentGroup replicationGroup, ComponentSystemBase system, global::Improbable.WorkerCore.Connection connection)
            {
                ...
                foreach (var chunk in chunkArray)
                {
                    ...
                    for (var i = 0; i < componentArray.Length; i++)
                    {
                        ...
                        {
                            var update = new global::Improbable.WorkerCore.SchemaComponentUpdate(1002);
