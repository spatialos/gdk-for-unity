    ...
    public partial class NonBlittableComponent
    {
        public class FirstCommandDiffCommandDeserializer : ICommandDiffDeserializer
        {
            ...
            public void AddResponseToDiff(CommandResponseOp op, ViewDiff diff, CommandMetaData commandMetaData)
            {
                ...
                var commandContext = commandMetaData.GetContext<global::Improbable.Gdk.Tests.NonblittableTypes.FirstCommandRequest>(ComponentId, 1, id);
        ...
        public class FirstCommandCommandSerializer : ICommandSerializer
        {
            ...
            public void Serialize(MessagesToSend messages, SerializedMessagesToSend serializedMessages, CommandMetaData commandMetaData)
            {
                ...
                for (int i = 0; i < requests.Count; ++i)
                {
                    ...
                    var context = new CommandContext<global::Improbable.Gdk.Tests.NonblittableTypes.FirstCommandRequest>(request.sendingEntity, request.request.Payload, request.request.Context);
                    commandMetaData.AddRequest<global::Improbable.Gdk.Tests.NonblittableTypes.FirstCommandRequest>(ComponentId, 1, request.requestId, context);
        ...
        public class SecondCommandDiffCommandDeserializer : ICommandDiffDeserializer
        {
            ...
            public void AddResponseToDiff(CommandResponseOp op, ViewDiff diff, CommandMetaData commandMetaData)
            {
                ...
                var commandContext = commandMetaData.GetContext<global::Improbable.Gdk.Tests.NonblittableTypes.SecondCommandRequest>(ComponentId, 2, id);
        ...
        public class SecondCommandCommandSerializer : ICommandSerializer
        {
            ...
            public void Serialize(MessagesToSend messages, SerializedMessagesToSend serializedMessages, CommandMetaData commandMetaData)
            {
                ...
                {
                    ref readonly var request = ref requests[i];
                    var context = new CommandContext<global::Improbable.Gdk.Tests.NonblittableTypes.SecondCommandRequest>(request.sendingEntity, request.request.Payload, request.request.Context);
                    commandMetaData.AddRequest<global::Improbable.Gdk.Tests.NonblittableTypes.SecondCommandRequest>(ComponentId, 2, request.requestId, context);
