    ...
    public partial class ExhaustiveMapValue
    {
        internal class DispatcherHandler : ComponentDispatcherHandler
        {
            ...
            public override void OnComponentUpdate(ComponentUpdateOp op)
            {
                ...
                {
                    updates = Improbable.Gdk.Tests.ExhaustiveMapValue.Update.Pool.Count > 0 ? Improbable.Gdk.Tests.ExhaustiveMapValue.Update.Pool.Pop() : new List<Improbable.Gdk.Tests.ExhaustiveMapValue.Update>();
                    var updatesComponent = new Improbable.Gdk.Tests.ExhaustiveMapValue.ReceivedUpdates
                    {
                        handle = ReferenceTypeProviders.UpdatesProvider.Allocate(World)
                    };
            ...
            public override void ExecuteReplication(ComponentGroup replicationGroup, ComponentSystemBase system, global::Improbable.WorkerCore.Connection connection)
            {
                ...
                foreach (var chunk in chunkArray)
                {
                    ...
                    for (var i = 0; i < componentArray.Length; i++)
                    {
                        ...
                        {
                            var update = new global::Improbable.WorkerCore.SchemaComponentUpdate(197718);
