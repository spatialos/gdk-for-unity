        ...
        internal class ComponentCleanup : ComponentCleanupHandler
        {
            public override EntityArchetypeQuery CleanupArchetypeQuery => new EntityArchetypeQuery
            {
                ...
                Any = new ComponentType[]
                {
                    ...
                    ComponentType.ReadOnly<Improbable.Gdk.Tests.ExhaustiveMapValue.ReceivedUpdates>(),
                    ComponentType.ReadOnly<AuthorityChanges<Improbable.Gdk.Tests.ExhaustiveMapValue.Component>>(),
                },
                ...
                EntityCommandBuffer buffer)
            {
                ...
                foreach (var chunk in chunkArray)
                {
                    ...
                    // Updates
                    var updateArray = new NativeArray<Improbable.Gdk.Tests.ExhaustiveMapValue.ReceivedUpdates>();
                    ...
                    // Authority
                    var authorityChangeArray = new NativeArray<AuthorityChanges<Improbable.Gdk.Tests.ExhaustiveMapValue.Component>>();
