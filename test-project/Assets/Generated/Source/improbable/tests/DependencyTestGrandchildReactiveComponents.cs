...
[assembly: RegisterGenericComponentType(typeof(ComponentAdded<global::Improbable.Tests.DependencyTestGrandchild.Component>))]
[assembly: RegisterGenericComponentType(typeof(ComponentRemoved<global::Improbable.Tests.DependencyTestGrandchild.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityChanges<global::Improbable.Tests.DependencyTestGrandchild.Component>))]
[assembly: RegisterGenericComponentType(typeof(Authoritative<global::Improbable.Tests.DependencyTestGrandchild.Component>))]
[assembly: RegisterGenericComponentType(typeof(NotAuthoritative<global::Improbable.Tests.DependencyTestGrandchild.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityLossImminent<global::Improbable.Tests.DependencyTestGrandchild.Component>))]
    ...
    public partial class DependencyTestGrandchild
    {
        public class UpdateReactiveComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                for (int i = 0; i < updatesReceived.Count; ++i)
                {
                    ...
                    List<Update> updates;
                    if (entityManager.HasComponent<global::Improbable.Tests.DependencyTestGrandchild.ReceivedUpdates>(entity))
                    {
                        updates = entityManager.GetComponentData<global::Improbable.Tests.DependencyTestGrandchild.ReceivedUpdates>(entity).Updates;
                    }
                    else
                    {
            ...
            {
                global::Improbable.Tests.DependencyTestGrandchild.ReferenceTypeProviders.UpdatesProvider.CleanDataInWorld(world);
            }
        }
        ...
        public class LegacyAuthorityComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                foreach (var entityId in world.GetExistingSystem<EntitySystem>().GetEntitiesAdded())
                {
                    ...
                    entityManager.AddComponent(entity,
                        ComponentType.ReadWrite<NotAuthoritative<global::Improbable.Tests.DependencyTestGrandchild.Component>>());
                }
            ...
            private void ApplyAuthorityChange(Unity.Entities.Entity entity, Authority authority, global::Improbable.Gdk.Core.EntityId entityId, World world, EntityManager entityManager)
            {
                switch (authority)
                {
                    case Authority.Authoritative:
                        if (!entityManager.HasComponent<NotAuthoritative<global::Improbable.Tests.DependencyTestGrandchild.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.Authoritative, Authority.NotAuthoritative, entityId);
                            return;
                        }

                        entityManager.RemoveComponent<NotAuthoritative<global::Improbable.Tests.DependencyTestGrandchild.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<Authoritative<global::Improbable.Tests.DependencyTestGrandchild.Component>>());

                        break;
                    case Authority.AuthorityLossImminent:
                        if (!entityManager.HasComponent<Authoritative<global::Improbable.Tests.DependencyTestGrandchild.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.AuthorityLossImminent, Authority.Authoritative, entityId);
                            return;
                        }

                        entityManager.AddComponent(entity, ComponentType.ReadWrite<AuthorityLossImminent<global::Improbable.Tests.DependencyTestGrandchild.Component>>());
                        break;
                    case Authority.NotAuthoritative:
                        ...
                        if (entityManager.HasComponent<AuthorityLossImminent<global::Improbable.Tests.DependencyTestGrandchild.Component>>(entity))
                        {
                            entityManager.RemoveComponent<AuthorityLossImminent<global::Improbable.Tests.DependencyTestGrandchild.Component>>(entity);
                        }

                        entityManager.RemoveComponent<Authoritative<global::Improbable.Tests.DependencyTestGrandchild.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<NotAuthoritative<global::Improbable.Tests.DependencyTestGrandchild.Component>>());
                        break;
                }
            }
            ...
            private void LogInvalidAuthorityTransition(Authority newAuthority, Authority expectedOldAuthority, global::Improbable.Gdk.Core.EntityId entityId)
            {
                ...
                //     .WithField("Component", "global::Improbable.Tests.DependencyTestGrandchild")
                // );
            }
        }
    }
