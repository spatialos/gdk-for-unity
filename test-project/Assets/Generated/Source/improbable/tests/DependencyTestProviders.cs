        ...
        internal static class ReferenceTypeProviders
        {
            ...
            public static class UpdatesProvider 
            {
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Improbable.Tests.DependencyTest.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Improbable.Tests.DependencyTest.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<global::Improbable.Tests.DependencyTest.Update> value)
                {
