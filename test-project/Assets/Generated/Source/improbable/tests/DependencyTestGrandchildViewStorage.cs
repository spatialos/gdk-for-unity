...
namespace Improbable.Tests
{
    ...
    {
        public class DependencyTestGrandchildViewStorage : IViewStorage, IViewComponentStorage<Snapshot>, IViewComponentUpdater<Update>
        {
            ...
            public void ApplyUpdate(long entityId, in Update update)
            {
                ...
                {
                    data.Grandchild = update.Grandchild.Value;
                }
