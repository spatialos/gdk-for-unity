...
namespace Generated.Improbable
{
    public partial class Metadata
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<Generated.Improbable.Metadata.Update>> Storage = new Dictionary<uint, List<Generated.Improbable.Metadata.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<Generated.Improbable.Metadata.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<Generated.Improbable.Metadata.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<Generated.Improbable.Metadata.Update> value)
                {
