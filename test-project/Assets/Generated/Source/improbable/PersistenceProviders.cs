...
namespace Generated.Improbable
{
    public partial class Persistence
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<Generated.Improbable.Persistence.Update>> Storage = new Dictionary<uint, List<Generated.Improbable.Persistence.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<Generated.Improbable.Persistence.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<Generated.Improbable.Persistence.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<Generated.Improbable.Persistence.Update> value)
                {
