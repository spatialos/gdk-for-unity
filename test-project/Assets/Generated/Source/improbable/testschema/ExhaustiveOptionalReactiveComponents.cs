...
[assembly: RegisterGenericComponentType(typeof(ComponentAdded<global::Improbable.TestSchema.ExhaustiveOptional.Component>))]
[assembly: RegisterGenericComponentType(typeof(ComponentRemoved<global::Improbable.TestSchema.ExhaustiveOptional.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityChanges<global::Improbable.TestSchema.ExhaustiveOptional.Component>))]
[assembly: RegisterGenericComponentType(typeof(Authoritative<global::Improbable.TestSchema.ExhaustiveOptional.Component>))]
[assembly: RegisterGenericComponentType(typeof(NotAuthoritative<global::Improbable.TestSchema.ExhaustiveOptional.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityLossImminent<global::Improbable.TestSchema.ExhaustiveOptional.Component>))]
    ...
    public partial class ExhaustiveOptional
    {
        public class UpdateReactiveComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                for (int i = 0; i < updatesReceived.Count; ++i)
                {
                    ...
                    List<Update> updates;
                    if (entityManager.HasComponent<global::Improbable.TestSchema.ExhaustiveOptional.ReceivedUpdates>(entity))
                    {
                        updates = entityManager.GetComponentData<global::Improbable.TestSchema.ExhaustiveOptional.ReceivedUpdates>(entity).Updates;
                    }
                    else
                    {
            ...
            {
                global::Improbable.TestSchema.ExhaustiveOptional.ReferenceTypeProviders.UpdatesProvider.CleanDataInWorld(world);
            }
        }
        ...
        public class LegacyAuthorityComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                foreach (var entityId in world.GetExistingSystem<EntitySystem>().GetEntitiesAdded())
                {
                    ...
                    entityManager.AddComponent(entity,
                        ComponentType.ReadWrite<NotAuthoritative<global::Improbable.TestSchema.ExhaustiveOptional.Component>>());
                }
            ...
            private void ApplyAuthorityChange(Unity.Entities.Entity entity, Authority authority, global::Improbable.Gdk.Core.EntityId entityId, World world, EntityManager entityManager)
            {
                switch (authority)
                {
                    case Authority.Authoritative:
                        if (!entityManager.HasComponent<NotAuthoritative<global::Improbable.TestSchema.ExhaustiveOptional.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.Authoritative, Authority.NotAuthoritative, entityId);
                            return;
                        }

                        entityManager.RemoveComponent<NotAuthoritative<global::Improbable.TestSchema.ExhaustiveOptional.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<Authoritative<global::Improbable.TestSchema.ExhaustiveOptional.Component>>());

                        break;
                    case Authority.AuthorityLossImminent:
                        if (!entityManager.HasComponent<Authoritative<global::Improbable.TestSchema.ExhaustiveOptional.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.AuthorityLossImminent, Authority.Authoritative, entityId);
                            return;
                        }

                        entityManager.AddComponent(entity, ComponentType.ReadWrite<AuthorityLossImminent<global::Improbable.TestSchema.ExhaustiveOptional.Component>>());
                        break;
                    case Authority.NotAuthoritative:
                        ...
                        if (entityManager.HasComponent<AuthorityLossImminent<global::Improbable.TestSchema.ExhaustiveOptional.Component>>(entity))
                        {
                            entityManager.RemoveComponent<AuthorityLossImminent<global::Improbable.TestSchema.ExhaustiveOptional.Component>>(entity);
                        }

                        entityManager.RemoveComponent<Authoritative<global::Improbable.TestSchema.ExhaustiveOptional.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<NotAuthoritative<global::Improbable.TestSchema.ExhaustiveOptional.Component>>());
                        break;
                }
            }
            ...
            private void LogInvalidAuthorityTransition(Authority newAuthority, Authority expectedOldAuthority, global::Improbable.Gdk.Core.EntityId entityId)
            {
                ...
                //     .WithField("Component", "global::Improbable.TestSchema.ExhaustiveOptional")
                // );
            }
        }
    }
