...
namespace Improbable.TestSchema
{
    ...
    public class ExhaustiveMapValueReaderSubscriptionManager : ReaderSubscriptionManager<ExhaustiveMapValue.Component, ExhaustiveMapValueReader>
    {
    ...
    [AutoRegisterSubscriptionManager]
    public class ExhaustiveMapValueWriterSubscriptionManager : WriterSubscriptionManager<ExhaustiveMapValue.Component, ExhaustiveMapValueWriter>
    {
    ...
    public class ExhaustiveMapValueReader : Reader<ExhaustiveMapValue.Component, ExhaustiveMapValue.Update>
    {
        ...
        internal ExhaustiveMapValueReader(World world, Entity entity, EntityId entityId) : base(world, entity, entityId)
        {
        }
