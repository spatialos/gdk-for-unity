...
namespace Improbable.TestSchema
{
    public partial class ExhaustiveMapValue
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            {
                ComponentType.ReadWrite<global::Improbable.TestSchema.ExhaustiveMapValue.Component>(),
                ComponentType.ReadOnly<global::Improbable.TestSchema.ExhaustiveMapValue.HasAuthority>(),
            };
            ...
            public void Clean()
            {
                ...
                var componentDataArray = query.ToComponentDataArray<global::Improbable.TestSchema.ExhaustiveMapValue.Component>(Allocator.Temp);
            ...
            {
                var entity = workerSystem.GetEntity(entityId);
                entityManager.RemoveComponent<global::Improbable.TestSchema.ExhaustiveMapValue.HasAuthority>(entity);
            ...
            private void SetAuthority(EntityId entityId, Authority authority)
            {
                switch (authority)
                {
                    ...
                    {
                        var entity = workerSystem.GetEntity(entityId);
                        entityManager.AddComponent<global::Improbable.TestSchema.ExhaustiveMapValue.HasAuthority>(entity);
                        break;
                    }
