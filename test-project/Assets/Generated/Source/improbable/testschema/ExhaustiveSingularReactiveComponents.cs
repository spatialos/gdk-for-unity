...
[assembly: RegisterGenericComponentType(typeof(ComponentAdded<global::Improbable.TestSchema.ExhaustiveSingular.Component>))]
[assembly: RegisterGenericComponentType(typeof(ComponentRemoved<global::Improbable.TestSchema.ExhaustiveSingular.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityChanges<global::Improbable.TestSchema.ExhaustiveSingular.Component>))]
[assembly: RegisterGenericComponentType(typeof(Authoritative<global::Improbable.TestSchema.ExhaustiveSingular.Component>))]
[assembly: RegisterGenericComponentType(typeof(NotAuthoritative<global::Improbable.TestSchema.ExhaustiveSingular.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityLossImminent<global::Improbable.TestSchema.ExhaustiveSingular.Component>))]
    ...
    public partial class ExhaustiveSingular
    {
        public class UpdateReactiveComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                for (int i = 0; i < updatesReceived.Count; ++i)
                {
                    ...
                    List<Update> updates;
                    if (entityManager.HasComponent<global::Improbable.TestSchema.ExhaustiveSingular.ReceivedUpdates>(entity))
                    {
                        updates = entityManager.GetComponentData<global::Improbable.TestSchema.ExhaustiveSingular.ReceivedUpdates>(entity).Updates;
                    }
                    else
                    {
            ...
            {
                global::Improbable.TestSchema.ExhaustiveSingular.ReferenceTypeProviders.UpdatesProvider.CleanDataInWorld(world);
            }
        }
        ...
        public class LegacyAuthorityComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                foreach (var entityId in world.GetExistingSystem<EntitySystem>().GetEntitiesAdded())
                {
                    ...
                    entityManager.AddComponent(entity,
                        ComponentType.ReadWrite<NotAuthoritative<global::Improbable.TestSchema.ExhaustiveSingular.Component>>());
                }
            ...
            private void ApplyAuthorityChange(Unity.Entities.Entity entity, Authority authority, global::Improbable.Gdk.Core.EntityId entityId, World world, EntityManager entityManager)
            {
                switch (authority)
                {
                    case Authority.Authoritative:
                        if (!entityManager.HasComponent<NotAuthoritative<global::Improbable.TestSchema.ExhaustiveSingular.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.Authoritative, Authority.NotAuthoritative, entityId);
                            return;
                        }

                        entityManager.RemoveComponent<NotAuthoritative<global::Improbable.TestSchema.ExhaustiveSingular.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<Authoritative<global::Improbable.TestSchema.ExhaustiveSingular.Component>>());

                        break;
                    case Authority.AuthorityLossImminent:
                        if (!entityManager.HasComponent<Authoritative<global::Improbable.TestSchema.ExhaustiveSingular.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.AuthorityLossImminent, Authority.Authoritative, entityId);
                            return;
                        }

                        entityManager.AddComponent(entity, ComponentType.ReadWrite<AuthorityLossImminent<global::Improbable.TestSchema.ExhaustiveSingular.Component>>());
                        break;
                    case Authority.NotAuthoritative:
                        ...
                        if (entityManager.HasComponent<AuthorityLossImminent<global::Improbable.TestSchema.ExhaustiveSingular.Component>>(entity))
                        {
                            entityManager.RemoveComponent<AuthorityLossImminent<global::Improbable.TestSchema.ExhaustiveSingular.Component>>(entity);
                        }

                        entityManager.RemoveComponent<Authoritative<global::Improbable.TestSchema.ExhaustiveSingular.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<NotAuthoritative<global::Improbable.TestSchema.ExhaustiveSingular.Component>>());
                        break;
                }
            }
            ...
            private void LogInvalidAuthorityTransition(Authority newAuthority, Authority expectedOldAuthority, global::Improbable.Gdk.Core.EntityId entityId)
            {
                ...
                //     .WithField("Component", "global::Improbable.TestSchema.ExhaustiveSingular")
                // );
            }
        }
    }
