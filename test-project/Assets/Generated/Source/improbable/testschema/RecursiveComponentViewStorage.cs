...
namespace Improbable.TestSchema
{
    ...
    {
        public class RecursiveComponentViewStorage : IViewStorage, IViewComponentStorage<Snapshot>, IViewComponentUpdater<Update>
        {
            ...
            public void ApplyUpdate(long entityId, in Update update)
            {
                ...
                {
                    data.B = update.B.Value;
                }

                if (update.C.HasValue)
                {
                    data.C = update.C.Value;
                }
