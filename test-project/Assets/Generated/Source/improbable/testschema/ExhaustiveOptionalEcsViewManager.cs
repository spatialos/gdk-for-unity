...
namespace Improbable.TestSchema
{
    public partial class ExhaustiveOptional
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            {
                ComponentType.ReadWrite<global::Improbable.TestSchema.ExhaustiveOptional.Component>(),
                ComponentType.ReadOnly<global::Improbable.TestSchema.ExhaustiveOptional.HasAuthority>(),
            };
            ...
            public void Clean()
            {
                var query = entityManager.CreateEntityQuery(typeof(global::Improbable.TestSchema.ExhaustiveOptional.Component));
                var componentDataArray = query.ToComponentDataArray<global::Improbable.TestSchema.ExhaustiveOptional.Component>(Allocator.TempJob);
            ...
            {
                var entity = workerSystem.GetEntity(entityId);
                entityManager.RemoveComponent<global::Improbable.TestSchema.ExhaustiveOptional.HasAuthority>(entity);
            ...
            private void SetAuthority(EntityId entityId, Authority authority)
            {
                switch (authority)
                {
                    ...
                    {
                        var entity = workerSystem.GetEntity(entityId);
                        entityManager.AddComponent<global::Improbable.TestSchema.ExhaustiveOptional.HasAuthority>(entity);
                        break;
                    }
