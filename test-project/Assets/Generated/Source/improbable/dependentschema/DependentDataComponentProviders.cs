        ...
        internal static class ReferenceTypeProviders
        {
            ...
            public static class Field17Provider 
            {
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(global::Improbable.TestSchema.SomeType?));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static global::Improbable.TestSchema.SomeType? Get(uint handle)
                {
                    if (!Storage.TryGetValue(handle, out var value))
                    {
                ...
                public static void Set(uint handle, global::Improbable.TestSchema.SomeType? value)
                {
                    if (!Storage.ContainsKey(handle))
                    {
                        throw new ArgumentException($"Field17Provider does not contain handle {handle}");
            ...
            public static class FooEventProvider 
            {
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Improbable.TestSchema.SomeType>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Improbable.TestSchema.SomeType> Get(uint handle)
                {
                    if (!Storage.TryGetValue(handle, out var value))
                    {
                        throw new ArgumentException($"FooEventProvider does not contain handle {handle}");
                    }
            
                    return value;
                }
            
                public static void Set(uint handle, List<global::Improbable.TestSchema.SomeType> value)
                {
                    if (!Storage.ContainsKey(handle))
                    {
                        throw new ArgumentException($"FooEventProvider does not contain handle {handle}");
            ...
            public static class BarCommandSenderProvider 
            {
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Improbable.DependentSchema.DependentDataComponent.BarCommand.Request>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Improbable.DependentSchema.DependentDataComponent.BarCommand.Request> Get(uint handle)
                {
                    if (!Storage.TryGetValue(handle, out var value))
                    {
                        throw new ArgumentException($"BarCommandSenderProvider does not contain handle {handle}");
                    }
            
                    return value;
                }
            
                public static void Set(uint handle, List<global::Improbable.DependentSchema.DependentDataComponent.BarCommand.Request> value)
                {
                    if (!Storage.ContainsKey(handle))
                    {
                        throw new ArgumentException($"BarCommandSenderProvider does not contain handle {handle}");
            ...
            public static class BarCommandRequestsProvider 
            {
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Improbable.DependentSchema.DependentDataComponent.BarCommand.ReceivedRequest>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Improbable.DependentSchema.DependentDataComponent.BarCommand.ReceivedRequest> Get(uint handle)
                {
                    if (!Storage.TryGetValue(handle, out var value))
                    {
                        throw new ArgumentException($"BarCommandRequestsProvider does not contain handle {handle}");
                    }
            
                    return value;
                }
            
                public static void Set(uint handle, List<global::Improbable.DependentSchema.DependentDataComponent.BarCommand.ReceivedRequest> value)
                {
                    if (!Storage.ContainsKey(handle))
                    {
                        throw new ArgumentException($"BarCommandRequestsProvider does not contain handle {handle}");
            ...
            public static class BarCommandResponderProvider 
            {
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Improbable.DependentSchema.DependentDataComponent.BarCommand.Response>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Improbable.DependentSchema.DependentDataComponent.BarCommand.Response> Get(uint handle)
                {
                    if (!Storage.TryGetValue(handle, out var value))
                    {
                        throw new ArgumentException($"BarCommandResponderProvider does not contain handle {handle}");
                    }
            
                    return value;
                }
            
                public static void Set(uint handle, List<global::Improbable.DependentSchema.DependentDataComponent.BarCommand.Response> value)
                {
                    if (!Storage.ContainsKey(handle))
                    {
                        throw new ArgumentException($"BarCommandResponderProvider does not contain handle {handle}");
            ...
            public static class BarCommandResponsesProvider 
            {
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Improbable.DependentSchema.DependentDataComponent.BarCommand.ReceivedResponse>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Improbable.DependentSchema.DependentDataComponent.BarCommand.ReceivedResponse> Get(uint handle)
                {
                    if (!Storage.TryGetValue(handle, out var value))
                    {
                        throw new ArgumentException($"BarCommandResponsesProvider does not contain handle {handle}");
                    }
            
                    return value;
                }
            
                public static void Set(uint handle, List<global::Improbable.DependentSchema.DependentDataComponent.BarCommand.ReceivedResponse> value)
                {
                    if (!Storage.ContainsKey(handle))
                    {
                        throw new ArgumentException($"BarCommandResponsesProvider does not contain handle {handle}");
